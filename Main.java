...
public class Main {
    public static void main(String[] args) {
        ...
        Book b1 = new Book(getInput("1st Book Title = "), getInput("1st Book Author = "), Integer.parseInt(getInput("1st book releasing year =  ")));
        Book b2 = new Book(getInput("2nd Book Title = "), getInput("2nd Book Author = "), Integer.parseInt(getInput("2nd book releasing year =  ")));
        Book b3 = new Book(getInput("3rd Book Title = "), getInput("3rd Book Author = "), Integer.parseInt(getInput("3rd book releasing year =  ")));     
        Book.count++;
        Book.count++;
        Book.count++;
